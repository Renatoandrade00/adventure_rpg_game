...
export default class GameScene extends Phaser.Scene {
  ...
  // Pathfinding Modular (Mobile Point-and-Click + Teclado Híbrido)
  ...
  create(data: { x?: number, y?: number }) {
    ...
    // Instancia o controlador universal de Pathfinding informando mapa e áreas onde pode pisar
    this.pathfinder = new Pathfinder(this, this.player, level, [0, 9, 11]);
  ...
  update() {
    ...
    // A classe Pathfinder resolve todo o cálculo híbrido (Mouse e Teclado)
